...
def send_telegram_message(message):
    bot_token = os.getenv("your bot token")  
    chat_id = os.getenv("your chat id ")
    ...
    while True:
        ...
        if action == "add":
            ...
            if is_strong_password(password):
                ...
                send_telegram_message(f"Password for {site} has been added.")
            ...
            if site in passwords:
                del passwords[site]
                save_passwords(passwords)
                send_telegram_message(f"Password for {site} has been deleted.")
